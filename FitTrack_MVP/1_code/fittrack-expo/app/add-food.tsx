...
export default function AddFoodScreen() {
  ...
  const updateServingSize = (foodId: string, size: string) => {
  ...
  const getTotalNutrient = (nutrient: 'protein' | 'carbs' | 'fat') => {
    return selectedFoods.reduce((total, food) => {
  ...
  return (
    <SafeAreaView style={globalStyles.safeArea}>
      ...
      <View style={globalStyles.topBar}>
        ...
        <Text style={globalStyles.headerTitle}>ADD FOOD</Text>
        <View style={{ width: 40 }} />
      </View>
        ...
        >
          ...
          {isSearching ? (
            ...
            <View style={styles.resultsContainer}>
              <Text style={globalStyles.subtitle}>Results</Text>
              <FlatList
                data={searchResults}
          ...
          {selectedFoods.length > 0 && (
            <View style={styles.selectedContainer}>
              <Text style={globalStyles.subtitle}>Your Meal</Text>
              ...
              <View style={styles.nutritionSummary}>
                <Text style={globalStyles.cardTitle}>Nutrition Summary</Text>
              ...
              >
                <View style={styles.buttonContent}>
                  ...
                  <Text style={globalStyles.primaryButtonText}>SAVE MEAL</Text>
                </View>
              </TouchableOpacity>
            </View>
          )}
